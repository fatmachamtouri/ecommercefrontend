...
const Affichearticles = ({ currentPage, setCurrentPage, itemsPerPage }) => {
    ...
    const renderArticles = () => {
                            ...
                            return <Card sx={{ maxWidth: 'auto', margin: 1 }} key={ind}>
                                ...
                                <CardActions>
                                    <Button disabled={art.qtestock <= 1} onClick={() =>
                                        handleAddToCart(art)} variant="contained" color="secondary" size="large">
        ...
        <button onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1}>
            Previous </button>
            <button onClick={() => handlePageChange(currentPage + 1)} disabled={articles.length< itemsPerPage}>
            Next </button>
            </>
    }
